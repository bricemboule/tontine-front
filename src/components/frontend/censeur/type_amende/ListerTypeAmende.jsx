...
export default function ListerTypeAmende(){

    const {typeAmendes, getTypeAmendes,supprimerTypeAmende} = useContext(RoleContext);
        ...
        <div className="content-wrapper">
            ...
            <div className="d-flex space-between p-3 bg-gray-light">
                <div className="d-flex flex-wrap gap-2">
                    <button type="button" className="btn btn-success"  style={{padding:"10px"}}>
                        <Link to='/censeur/type_amende/ajouter' className="text-decoration-none text-white">
                            <i className="fa fa-plus pt-1"></i>
                            <span className="pl-2"> Ajouter un  type d'amende </span>
                        </Link>
                    </button> 
                    <button type="button" className="btn btn-danger" >
                        <i className="fa fa-trash pt-1"></i>
                        <span className="pl-2">Supprimer un type d'amende</span>
                    </button>
            ...
            <table id="paginationNumbers" className= "table"   width="100%">
                <thead >
                        ...
                        <th scope="col" className="text-center width-20 p-3" style={{width:"450px"}}>Type amende</th>
                    ...
                    {typeAmendes.map((type_amende)=> {
                        return(
                            ...
                            <td className="text-center p-3">
                                ...
                                <button className="btn btn-link btn-floating" ><Link to={`/censeur/type_amende/${type_amende.id}/modifier`}> <i className="far fa-edit text-green"></i></Link> </button>
                                <button className="btn btn-link btn-floating" onClick={()=>supprimerTypeAmende(type_amende.id)}> <i className="far fa-trash-alt text-red"></i></button>
                            </td>
                        </tr>
                        ); }
                    )}
