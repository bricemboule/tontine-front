...
export default function AjouterMembre(){
    const {roles, getRoles, value, value1, setValue, setValue1,userInput, SaveMember, handleInput} = useContext(RoleContext); 
            ...
            <div className="content-wrapper">
                <div className="content">
                    <div className="container-fluid">
                        <div className="row">
                        <br/>
                            <Form onSubmit={SaveMember} className='pt-2'>
                                <Row className="mb-3">
                                    <Form.Group as={Col} controlId="formGridNom">
                                        <Form.Label style={{ fontWeight: "bolder", fontSize: "15px" }}>Nom :  <span className='etoile'>*</span></Form.Label>
                                        <Form.Control type="text" placeholder="nom membre" name='nom' onChange={handleInput} />
                                    </Form.Group>

                                    <Form.Group as={Col} controlId="formGridPrenom">
                                        <Form.Label style={{ fontWeight: "bolder", fontSize: "15px" }}>Prenom :  </Form.Label>
                                ...
                                <Row className="mb-3">
                                    ...
                                    </Form.Group>
                                    {
                                        (userInput.sexe === 'M') ?   (
                                                ...
                                                <Form.Group as={Col} controlId="formGridNbFemme">
                                                    <Form.Label style={{fontWeight : "bolder", fontSize:"15px"}}>Nombre d' Epoux <span className='etoile'>*</span>  </Form.Label>
                                    ...
                                    <Form.Select aria-label="Default select example"  name='role' onChange={handleInput}>
                                        <option value=""></option>
                                            {roles.map((role)=>{
                                                    ...
                                                    if (role.nom ==="Membre" || role.nom==="membre"){
                                                        return (
                                ...
                                <Row className="mb-3">
                                    <Form.Group as={Col} controlId="formGridLogin">
                                        <Form.Label style={{ fontWeight: "bolder", fontSize: "15px" }}>Login : <span className='etoile'>*</span></Form.Label>
                                        <Form.Control type="text" placeholder="Entrer login" name='login' onChange={handleInput}/>
                                    </Form.Group>

                                    <Form.Group as={Col} controlId="formGridPassword">
                                        <Form.Label style={{ fontWeight: "bolder", fontSize: "15px" }}>Mot de passe : <span className='etoile'>*</span></Form.Label>
                                ...
                                <Row className="mb-3">
                                    ...
                                    <Form.Group as={Col} className="mb-3" controlId="formGridPhoto">
                                        <Form.Label style={{ fontWeight: "bolder", fontSize: "15px" }}>Photo : <span className='etoile'>*</span></Form.Label>
